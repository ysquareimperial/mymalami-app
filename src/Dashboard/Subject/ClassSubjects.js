const subject = [
  ...
  {
    value: "AUTO BODY REPAIRS AND SPRAY PAINTING",
    label: "AUTO BODY REPAIRS AND SPRAY PAINTING",
  },
  {
    value: "APPLIED ELECTRICITY OR BASIC ELECTRICITY",
    label: "APPLIED ELECTRICITY OR BASIC ELECTRICITY",
  },
  ...
  {
    value: "BLOCKLAYING, BRICKLAYING AND CONCRETING",
    label: "BLOCKLAYING, BRICKLAYING AND CONCRETING",
  },
  ...
  {
    value: "ELECTRONICS OR BASIC ELECTRONICS",
    label: "ELECTRONICS OR BASIC ELECTRONICS",
  },
  {
  ...
  {
    value: "RADIO,TELEVISION AND ELECTRONICS WORKS",
    label: "RADIO,TELEVISION AND ELECTRONICS WORKS",
  },
  { value: "PRINTING CRAFT PRACTICE", label: "PRINTING CRAFT PRACTICE" },
  {
    value: "PRINCIPLES OF COST ACCOUNTING",
    label: "PRINCIPLES OF COST ACCOUNTING",
  },
  ...
  {
    value: "HEALTH EDUCATION OR HEALTH SCIENCE",
    label: "HEALTH EDUCATION OR HEALTH SCIENCE",
  },
  { value: "HAUSA", label: "HAUSA" },
  {
    value: "GSM PHONES MAINTENANCE AND REPAIRS",
    label: "GSM PHONES MAINTENANCE AND REPAIRS",
  },
  ...
  {
    value: "GENERAL MATHEMATICS OR MATHEMATICS",
    label: "GENERAL MATHEMATICS OR MATHEMATICS",
  },
  ...
  {
    value: "WEST AFRICAN TRADITIONAL RELIGION",
    label: "WEST AFRICAN TRADITIONAL RELIGION",
  },
  {
    value: "WELDING AND FABRICATION ENGINEERING CRAFT PRACTICE",
    label: "WELDING AND FABRICATION ENGINEERING CRAFT PRACTICE",
  },
