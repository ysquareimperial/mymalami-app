              ...
              <Row>
                ...
                <Col md={10}>
                  <p className="c-review">
                    afasfsdafasdf fasdfasdf afasdfas fa adsfasd fasd fasdf adfa
                    fa fafasdfasd asdfasfsd gsgsdf gsgsdf g sfdgsdgsd f sfgsdfg
                  </p>
                </Col>
                <div className="text-center">
            ...
            <Card className="p-card-2 shadow py-4 px-4 text-center">
              <div className="p-type-1 shadow">
                ...
                <h5 style={{ fontWeight: "bold" }}>
                  ₦ 0.00<small style={{ fontWeight: "lighter" }}>/month</small>
                </h5>
              </div>
              <p>fasfsdf fasfsdf</p>
              <p>fasfsdf fasfsdf</p>
          ...
          <Col md={2}>
            <Card className="p-card-2 shadow py-4 px-4 text-center">
              <div className="p-type-1 shadow">
                <h4>Bronze</h4>
                <h5 style={{ fontWeight: "bold" }}>
                  ₦ 1,000<small style={{ fontWeight: "lighter" }}>/month</small>
                </h5>
              </div>
              <p>fasfsdf fasfsdf</p>
              <p>fasfsdf fasfsdf</p>
